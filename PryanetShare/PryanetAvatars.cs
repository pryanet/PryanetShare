...
{
    public static class PryanetAvatars
    {
        ...
        public static string GetAvatar (string email, int size, string target_path)
        {
            ...
            try {
                ...
                PryanetLogger.LogInfo ("Avatars", "Error fetching avatar for " + email, e);
                return null;
            }
            ...
            try {
                ...
                if (buffer.Length > 255) {
                    if (!Directory.Exists (avatars_path)) {
                        ...
                        PryanetLogger.LogInfo ("Avatars", "Created '" + avatars_path + "'");
                    }
                    
                    File.WriteAllBytes (avatar_file_path, buffer);
                    PryanetLogger.LogInfo ("Avatars", "Fetched " + size + "x" + size + " avatar for " + email);
            ...
            X509Certificate certificate, X509Chain chain, SslPolicyErrors errors)
        {
            ...
            if (!certificate2.Thumbprint.Equals (gravatar_cert_fingerprint)) {
                PryanetLogger.LogInfo ("Avatars", "Invalid certificate for https://www.gravatar.com/");
                return false;
            }
