...
namespace PryanetShare {
    ...
    public static class PryanetUIHelpers {
        ...
        public static BitmapFrame GetImageSource (string name, string type)
        {
            ...
            Stream image_stream = assembly.GetManifestResourceStream("PryanetShare.Pixmaps." + name + "." + type);
        ...
        {                                          
            Assembly assembly   = Assembly.GetExecutingAssembly ();
            Stream image_stream = assembly.GetManifestResourceStream ("PryanetShare.Pixmaps." + name + ".png");
        ...
        {                                          
            ...
            StreamReader html_reader = new StreamReader (
                assembly.GetManifestResourceStream ("PryanetShare.HTML." + name));
